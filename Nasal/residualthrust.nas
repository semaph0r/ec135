...
var rpm_1 = props.globals.getNode("engines/engine/rpm").getValue() or 0;
var rpm_2 = props.globals.getNode("engines/engine[1]/rpm").getValue() or 0;
...
var rt1= (0.00012*(torque + 12.0)*P1);
var rt2= (0.00012*(torque + 12.0)*P2);
...
if (rpm_2 >1){
setprop ("engines/engine/residualthrust", rt2);
}
